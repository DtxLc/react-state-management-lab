        ...
        <ul>
          {team.map((fighter) => (
            <li key={fighter.id} className="fighter-card">
              <div className="fighter-image">150 x 150</div>
              <div className="fighter-name">{fighter.name}</div>
              <div className="fighter-stats">Price: {fighter.price}</div>
              <div className="fighter-stats">Strength: {fighter.strength}</div>
              <div className="fighter-stats">Agility: {fighter.agility}</div>
              <button className="remove-button" onClick={() => handleRemoveFighter(fighter)}>Remove</button>
            </li>
          ))}
        </ul>
      )}

      <div className="section-title">Fighters</div>
      <ul>
        {zombieFighters.map((fighter) => (
          <li key={fighter.id} className="fighter-card">
            ...
            <div className="fighter-stats">Strength: {fighter.strength}</div>
            <div className="fighter-stats">Agility: {fighter.agility}</div>
            <button className="add-button" onClick={() => handleAddFighter(fighter)}>Add</button>
          </li>
        ))}
      </ul>
    </div>
